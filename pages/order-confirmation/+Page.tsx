...
import { CheckCircle, Package, ArrowRight, Home, ShoppingBag, XCircle, Clock, AlertTriangle } from "lucide-react";
...
export default function OrderConfirmationPage() {
  ...
  const isPaymentSuccess = paymentState === "success" || paymentState === "none";
  const isPaymentPending = paymentState === "pending";
  const isPaymentFailed = paymentState === "cancelled" || paymentState === "failed";
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4 py-16">
      <div className="max-w-lg w-full bg-white rounded-2xl shadow-sm border border-gray-100 p-8 md:p-12 text-center">
        ...
        {isPaymentFailed && (
          <p className="text-sm text-gray-400 mb-8">
            Don't worry — no charges were made. You can contact us at support for help.
          </p>
        )}
