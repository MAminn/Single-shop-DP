...
import { Store, Loader2, ArrowRight, Users, Award, TrendingUp } from "lucide-react";
        ...
        <div className="relative z-10 container mx-auto px-4">
          <div className={`text-center max-w-4xl mx-auto transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}>
            ...
            <p className="text-gray-600 text-lg leading-relaxed max-w-2xl mx-auto mb-12">
              ...
              Each brand represents quality, authenticity, and innovative design.
            </p>
        ...
        <div className="container mx-auto px-4">
          {templateData.vendors.length === 0 ? (
            <div className="text-center py-20 bg-white rounded-3xl border border-gray-100">
              ...
              <h3 className="text-3xl font-light text-gray-900 mb-4">No brands found</h3>
              ...
              {templateData.vendors.map((vendor, index) => (
                ...
                >
                  <div className="p-8">
                    ...
                    >
                      <Button
                        className="w-full bg-gray-900 hover:bg-gray-800 text-white border-0 transition-all duration-300 hover:shadow-lg group-hover:-translate-y-0.5 rounded-xl py-3"
                      >
                        Explore Collection
