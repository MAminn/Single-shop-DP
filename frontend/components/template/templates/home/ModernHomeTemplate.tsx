...
import { ShoppingBag, Users, ArrowRight, Star, TrendingUp, Shield, Truck, Award, Clock } from "lucide-react";
            ...
            <div className={`space-y-8 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}>
              ...
              <div className="space-y-6">
                ...
                <p className="text-gray-600 text-lg leading-relaxed max-w-lg">
                  Discover exceptional fashion from curated designers and brands. 
                  Every piece tells a story, every purchase supports creativity.
                </p>
              </div>
            ...
            <div className={`relative transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-12'}`}>
              <div className="grid grid-cols-12 grid-rows-12 gap-4 h-[600px]">
                ...
                <div className="col-span-4 row-span-3 bg-gray-50 rounded-xl p-4 flex flex-col justify-center border border-gray-100">
                  ...
                  <div className="text-sm text-gray-600 font-medium">Curated Brands</div>
                </div>
                ...
                <div className="col-span-4 row-span-4 bg-gray-900 rounded-xl p-4 flex flex-col justify-center text-white">
                  ...
                  <div className="text-xs text-gray-300 mt-1">Verified authentic</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="group text-center p-8 bg-white rounded-2xl border border-gray-100 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              ...
              <div className="text-sm text-gray-500 mt-1">Authenticated quality</div>
            </div>
            <div className="group text-center p-8 bg-white rounded-2xl border border-gray-100 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              <div className="w-12 h-12 bg-gray-100 rounded-xl flex items-center justify-center mx-auto mb-4 group-hover:bg-gray-900 transition-colors duration-300">
            ...
            <div className="group text-center p-8 bg-white rounded-2xl border border-gray-100 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
              ...
              <div className="text-2xl font-light text-gray-900 mb-2">7 Days</div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="relative order-2 lg:order-1">
              ...
              <div className="absolute -bottom-6 -right-6 bg-gray-900 text-white p-6 rounded-2xl shadow-xl">
                ...
                <div className="text-xs text-gray-300">Crafting experiences</div>
              </div>
            </div>
            ...
            <div className="space-y-8 order-1 lg:order-2">
              <div className="space-y-6">
                <div className="inline-flex items-center bg-gray-50 px-4 py-2 rounded-full border border-gray-100">
                  ...
                  <span className="text-gray-700 text-sm font-medium tracking-wide">OUR STORY</span>
                </div>
                <h2 className="text-4xl md:text-5xl font-light text-gray-900 leading-tight">
                  Redefining Fashion
                  <span className="block font-normal text-gray-600">Commerce</span>
                </h2>
              </div>
              ...
              <div className="space-y-6 text-gray-600 leading-relaxed">
                <p className="text-lg">
                  ...
                  creativity, and connection. Our platform bridges the gap between 
                  exceptional designers and discerning customers.
                </p>
                <p>
                  Every brand we partner with shares our commitment to quality, 
                  authenticity, and sustainable practices. Together, we're building 
                  a marketplace that values both style and substance.
                </p>
              </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <div className="inline-flex items-center bg-white px-4 py-2 rounded-full border border-gray-100 mb-6">
              <div className="w-2 h-2 bg-gray-900 rounded-full mr-3"></div>
              <span className="text-gray-700 text-sm font-medium tracking-wide">COLLECTIONS</span>
            </div>
            <h2 className="text-4xl md:text-5xl font-light text-gray-900 mb-4 leading-tight">
              Curated for You
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto text-lg leading-relaxed">
              Explore our carefully selected collections from the world's most innovative designers
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="group relative bg-white rounded-3xl overflow-hidden shadow-sm border border-gray-100 hover:shadow-xl transition-all duration-500 hover:-translate-y-2">
              <Link href="/featured/men" className="block">
                ...
                <div className="p-8">
                  <h3 className="text-2xl font-light text-gray-900 mb-2">Men's Collection</h3>
                  <p className="text-gray-600 mb-4">Contemporary styles for the modern gentleman</p>
            ...
            <div className="group relative bg-white rounded-3xl overflow-hidden shadow-sm border border-gray-100 hover:shadow-xl transition-all duration-500 hover:-translate-y-2">
              <Link href="/featured/women" className="block">
                ...
                <div className="p-8">
                  <h3 className="text-2xl font-light text-gray-900 mb-2">Women's Collection</h3>
                  <p className="text-gray-600 mb-4">Elegant designs that celebrate individuality</p>
                  <div className="flex items-center text-gray-900 font-medium group-hover:translate-x-2 transition-transform duration-300">
            ...
            <div className="group relative bg-white rounded-3xl overflow-hidden shadow-sm border border-gray-100 hover:shadow-xl transition-all duration-500 hover:-translate-y-2">
              <Link href="/featured/brands" className="block">
                ...
                <div className="p-8">
                  <h3 className="text-2xl font-light text-gray-900 mb-2">Premium Brands</h3>
                  <p className="text-gray-600 mb-4">Exclusive partnerships with leading designers</p>
                  <div className="flex items-center text-gray-900 font-medium group-hover:translate-x-2 transition-transform duration-300">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            <div className="inline-flex items-center bg-white/10 px-4 py-2 rounded-full border border-white/20 mb-8">
              ...
              <span className="text-white/90 text-sm font-medium tracking-wide">JOIN THE COMMUNITY</span>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-white">
              <div className="text-center group">
                <div className="text-3xl font-light mb-2 group-hover:scale-110 transition-transform duration-300">50K+</div>
                <div className="text-white/60 text-sm tracking-wide">SATISFIED CUSTOMERS</div>
              </div>
              <div className="text-center group">
                <div className="text-3xl font-light mb-2 group-hover:scale-110 transition-transform duration-300">1000+</div>
                <div className="text-white/60 text-sm tracking-wide">CURATED PIECES</div>
              </div>
              <div className="text-center group">
                <div className="text-3xl font-light mb-2 group-hover:scale-110 transition-transform duration-300">24/7</div>
                <div className="text-white/60 text-sm tracking-wide">EXPERT SUPPORT</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            ...
            <div className="md:col-span-2">
              ...
              <p className="text-gray-600 mb-8 max-w-md leading-relaxed">
                Curating exceptional fashion experiences through thoughtful design 
                and sustainable practices. Discover your authentic style.
              </p>
              <div className="flex space-x-4">
                <Link href="#" className="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center hover:bg-gray-900 hover:text-white transition-all duration-300 group">
            ...
            {/* Collections */}
            <div>
              <h3 className="text-sm font-medium text-gray-900 mb-6 tracking-wide">COLLECTIONS</h3>
              <ul className="space-y-4">
                <li><Link href="/products" className="text-gray-600 hover:text-gray-900 transition-colors text-sm">All Products</Link></li>
                <li><Link href="/featured/men" className="text-gray-600 hover:text-gray-900 transition-colors text-sm">Men's</Link></li>
                <li><Link href="/featured/women" className="text-gray-600 hover:text-gray-900 transition-colors text-sm">Women's</Link></li>
                <li><Link href="/featured/brands" className="text-gray-600 hover:text-gray-900 transition-colors text-sm">Premium Brands</Link></li>
            ...
            {/* Support */}
            <div>
              <h3 className="text-sm font-medium text-gray-900 mb-6 tracking-wide">SUPPORT</h3>
              <ul className="space-y-4">
                <li><Link href="/contact" className="text-gray-600 hover:text-gray-900 transition-colors text-sm">Contact</Link></li>
                <li><Link href="/shipping" className="text-gray-600 hover:text-gray-900 transition-colors text-sm">Shipping</Link></li>
                <li><Link href="/returns" className="text-gray-600 hover:text-gray-900 transition-colors text-sm">Returns</Link></li>
                <li><Link href="/size-guide" className="text-gray-600 hover:text-gray-900 transition-colors text-sm">Size Guide</Link></li>
                <li><Link href="#faq" className="text-gray-600 hover:text-gray-900 transition-colors text-sm">FAQ</Link></li>
              </ul>
            </div>
          </div>
          ...
          <div className="border-t border-gray-100 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="flex space-x-8 text-sm">
                ...
                <Link href="/cookies" className="text-gray-500 hover:text-gray-900 transition-colors">Cookies</Link>
              </div>
            </div>
          </div>
        </div>
