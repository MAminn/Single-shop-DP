...
export function TemplatePreview({
  ...
  const { activeTemplates, switchTemplate } = useTemplate();
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="flex items-center gap-1">
                  ...
                  <Button
                    ...
                    size="sm"
                    onClick={zoomIn}
                    disabled={zoom >= (ZOOM_LEVELS[ZOOM_LEVELS.length - 1] ?? 0)}
                  >
        ...
        {showRulers && (
          <>
            ...
            <div className="h-6 bg-white border-b border-gray-300 mb-2 relative">
              {Array.from({ length: Math.ceil(containerDimensions.width / 50) }, (_, i) => (
                <div
                  key={"ruler"}
            ...
            <div className="w-6 bg-white border-r border-gray-300 mr-2 absolute left-4 top-16 z-10">
              {Array.from({ length: Math.ceil(containerDimensions.height / 50) }, (_, i) => (
                <div
                  key={"ruler"}
            ...
            <div className="w-full h-full overflow-auto">
              {error ? (
                ...
                <TemplateRenderer
                  ...
                  fallbackComponent={({ error: renderError, templateId: fallbackTemplateId }) => (
                    <div className="flex items-center justify-center h-full bg-gray-50">
                      <div className="text-center p-8">
                        ...
                        <p className="text-gray-600 mb-4">
                          {renderError || `Preview for ${fallbackTemplateId || 'template'} will appear here`}
                        </p>
