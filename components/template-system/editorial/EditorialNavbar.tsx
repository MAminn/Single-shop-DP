...
export function EditorialNavbar() {
  ...
  return (
    <motion.nav
      ...
      className="fixed top-0 inset-x-0 z-[10000] py-4 lg:py-5"
      animate={{
    ...
    >
      <div className="px-6 lg:px-8 grid grid-cols-3 items-center min-h-12 max-w-7xl mx-auto">
                ...
                <div className="flex flex-col h-full">
                  <div className="p-6 border-b border-stone-200 w-full flex justify-center">
                    <Link
                      ...
                      className="text-xl font-light tracking-[0.14em] text-stone-900 uppercase"
                    >
                      {STORE_NAME}
                    </Link>
                  </div>
        ...
        <div className="flex justify-center">
          <Link
            href="/"
            className={`text-xl lg:text-2xl font-extralight tracking-[0.18em] uppercase transition-colors duration-200 ${linkCls}`}
          >
            {STORE_NAME}
          </Link>
        </div>
